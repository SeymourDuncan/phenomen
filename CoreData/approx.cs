...
namespace CoreData
{
    class CurveFunctions
    {
        ...
        public static double ErrorSquared(List<Point> pts, double a, double b, double c)
        {
        ...
        // dE/da
        private static double dEda(List<Point> pts, double a, double b, double c)
        {
            double total = 0;
            for (int i = 0; i < pts.Count; i++)
            {
        ...
        // dE/db
        private static double dEdb(List<Point> pts, double a, double b, double c)
        {
            double total = 0;
            for (int i = 0; i < pts.Count; i++)
            {
        ...
        // dE/dc
        private static double dEdc(List<Point> pts, double a, double b, double c)
        {
            double total = 0;
            for (int i = 0; i < pts.Count; i++)
            {
        ...
        public static double FindGoodFit(List<Point> pts,
        ...
        private static double FollowGradient(List<Point> pts,
